...
#
#     source /root/6g-network/scripts/channel_contract_map.sh
#
# اگر پروژه جای دیگری باشد — مثلاً /root/6g-network-raft — این خط به فایلی
...
PATTERN='/root/6g-network[a-zA-Z0-9_-]*'
