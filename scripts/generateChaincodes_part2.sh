#!/bin/bash
# generateChaincodes_part2.sh
#
# هر 7 قراردادی که این اسکریپت قبلاً می‌ساخت، مکان‌محور است و حالا
...
if [ ! -f "$SPATIAL" ]; then
    ...
    echo "بدون آن، این 7 قرارداد ساخته نمی‌شوند." >&2
    exit 1
fi

echo "part2 → واگذاری به generateChaincodes_spatial.sh (7 قرارداد مکانی)"
